...
import com.cm4j.test.generator.dict.entity.DictCountryFog;
...
public class Dict_Generator {
    ...
    // 待生成的entity
    private static final Class entity = DictCountryFog.class;
    private static final String commnet = "国战迷雾缓存";
